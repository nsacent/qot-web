                ...
                <section className="py-6">
                    ...
                    <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_0.42fr]">
                        ...
                        <aside className="space-y-6">
                            <div className="h-fit rounded-[34px] bg-white p-5 shadow-[0_18px_60px_rgba(15,23,42,0.10)] ring-1 ring-black/5 sm:p-6">
                                <h2 className="text-xl font-black text-slate-950">
                                    Seller Information
                                </h2>

                                <p className="mt-2 text-sm font-semibold text-slate-500">
                                    Contact the seller safely through QOT.
                                </p>
                                ...
                                <div className="mt-5 rounded-[28px] bg-slate-50 p-5">
                                    ...
                                    {sellerId && (
                                        <a
                                            href={`/sellers/${sellerId}`}
                                            className="mt-4 inline-flex rounded-2xl bg-white px-4 py-3 text-sm font-black text-orange-600 ring-1 ring-orange-100 hover:bg-orange-50"
                                        >
                                            View seller profile →
                                        </a>
                                    )}
